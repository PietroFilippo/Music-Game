...
const pt: Dict = {
  ...
  'menu.learn': 'Aprender',
  'menu.tab.games': 'Jogos',
  'menu.tab.stats': 'Estatísticas',
  ...
  'stats.total': 'Total',
  'stats.reset': 'Resetar',
  'stats.resetAll': 'Resetar todo o progresso',
  'stats.resetHint': 'Apaga partidas e pontuações. As configurações não são afetadas.',
  'stats.confirmGame': 'Apagar o progresso de {game}?',
  'stats.confirmAll': 'Apagar todo o progresso?',
  'stats.confirmNote': 'Isso não pode ser desfeito.',
  ...
  'difficulty.none': 'Sem tempo',
  'difficulty.easy': 'Fácil ({s}s)',
  'difficulty.medium': 'Médio ({s}s)',
  'difficulty.hard': 'Difícil ({s}s)',
...
const en: Dict = {
  ...
  'stats.total': 'Total',
  'stats.reset': 'Reset',
  'stats.resetAll': 'Reset all progress',
  'stats.resetHint': 'Clears plays and scores. Settings are not affected.',
  'stats.confirmGame': 'Delete progress for {game}?',
  'stats.confirmAll': 'Delete all progress?',
  'stats.confirmNote': 'This cannot be undone.',
  'stats.cancel': 'Cancel',
  'stats.delete': 'Delete',
  ...
  'difficulty.none': 'No timer',
  'difficulty.easy': 'Easy ({s}s)',
  'difficulty.medium': 'Medium ({s}s)',
  'difficulty.hard': 'Hard ({s}s)',
